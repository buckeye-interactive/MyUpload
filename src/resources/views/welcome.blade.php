        ...
        <div class="container text-center">
            ...
            <div class="row position-relative instruction-container text-left">
                ...
                <div class="col-md-4">
                    ...
                    <p class="mb-5"><strong>Upload your items and permission form in the box above.</strong> You must have your parent or guardian sign the permission form you downloaded from the <a href="https://columbuslibrary.org/teens" target="_blank">Teens website page</a>. Upload it and as many images/videos/audio files as you'd like. Accepted file formats are: {{ env('UPLOAD_FILE_TYPES') }}</p>
                </div>
                <div class="col-md-4">
                    <div class="position-relative">
